...
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'timeofcode')
BEGIN
    CREATE DATABASE [timeofcode]
END
GO
...
IF OBJECT_ID('dbo.CodeExamples', 'U') IS NOT NULL DROP TABLE dbo.CodeExamples;
